...
class Gusenica():
    ...
    def draw_snake(self, sc, color, hat1rl, hat2rl, hat3rl, hat1ud, hat2ud, hat3ud,):
        ...
        bootsu = pygame.transform.scale(bootsu, (35, 35))
        bootsd = pygame.transform.scale(bootsd, (35, 35))
        bootsl = pygame.transform.scale(bootsl, (35, 35))
        bootsr = pygame.transform.scale(bootsr, (35, 35))
        chipd = pygame.transform.scale(chipd, (35, 35))
        chipu = pygame.transform.scale(chipu, (35, 35))
        chipr = pygame.transform.scale(chipr, (35, 35))
        chipl = pygame.transform.scale(chipl, (35, 35))
        plashu = pygame.transform.scale(plashu, (35, 35))
        plashd = pygame.transform.scale(plashd, (35, 35))
        plashr = pygame.transform.scale(plashr, (35, 35))
        plashl = pygame.transform.scale(plashl, (35, 35))
